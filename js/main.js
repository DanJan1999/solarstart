...
function calculateSolar() {
    ...
    var panelNames = panelInfo[1]

    var panelsNeeded = Math.ceil(realWattNeeds / panelOutput)

    var feedback = "";
    feedback += "<p>Based on your average daily use of "+ Math.round(dailyUseKw) +" kWh, you will need to purchase "+ panelsNeeded +" "+ panelNames +" solar panels to offset 100% of your electricity bill.</p>";
    ...
    feedback += "<The "+ panelNames +" panel you selected generates about "+ panelOutput +" watts per hour.</p>";
